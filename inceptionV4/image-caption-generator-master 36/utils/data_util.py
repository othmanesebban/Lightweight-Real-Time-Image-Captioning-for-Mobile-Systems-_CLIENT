...
def prepare_coco_captions(filename="C:/Users/M538813/Desktop/me/Dataset/captions_val2017.json"):
    '''
...
def preprocess_coco_captions(filenames, captions):
    ...
    df['caption'] = df['caption'].apply(word_tokenize).apply(lambda x: x[:34]).apply(" ".join).str.lower()
