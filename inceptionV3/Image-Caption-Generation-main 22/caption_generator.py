...
class Caption_Generator():
    ...
    def Words_to_IDs(self, wtoidx, caption_batch):
        max_len = 22 # Nouvelle longueur de légende
        for i, caption in enumerate(caption_batch):
            ...
            # Pad the caption to the maximum length (22 mots)
            while len(cap) < max_len:
                cap.append(wtoidx["<PAD>"])
    ...
    def generate_mask(self, ID_batch, wtoidx):
        ...
        ID_batch_new = np.zeros((ID_batch.shape[0], 22))  # Utilisation de la nouvelle longueur (22 mots)
