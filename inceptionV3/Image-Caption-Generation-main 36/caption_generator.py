...
class Caption_Generator():
    ...
    def Words_to_IDs(self, wtoidx, caption_batch):
        max_len = 36  # Nouvelle longueur de légende
        for i, caption in enumerate(caption_batch):
            ...
            # Pad the caption to the maximum length (36 mots)
    ...
    def generate_mask(self, ID_batch, wtoidx):
        ...
        ID_batch_new = np.zeros((ID_batch.shape[0], 36))  # Utilisation de la nouvelle longueur (36 mots)
